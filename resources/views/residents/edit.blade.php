                    ...
                    <div class="col-md-3">
                        ...
                        <select name="gender" class="form-select" required>
                            @foreach(['Male', 'Female'] as $option)
                                <option value="{{ $option }}" @selected(old('gender', $resident->gender) === $option)>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="civil_status" class="form-select" required>
                            @foreach(['Single', 'Married', 'Widowed', 'Separated', 'Divorced'] as $option)
                                <option value="{{ $option }}" @selected(old('civil_status', $resident->civil_status) === $option)>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="voter_status" class="form-select" required>
                            @foreach(['Registered', 'Unregistered', 'Suspended'] as $option)
                                <option value="{{ $option }}" @selected(old('voter_status', $resident->voter_status) === $option)>
                                    {{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
