                ...
                <div class="col-md-3">
                    ...
                    <select name="voter_status" class="form-select" required>
                        @foreach(['Registered', 'Unregistered', 'Suspended'] as $option)
                            <option value="{{ $option }}" @selected(old('voter_status', 'Unregistered') === $option)>{{ $option }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <select name="residency_status" class="form-select" required>
                        @foreach(['Active', 'Deceased', 'Transferred'] as $option)
                            <option value="{{ $option }}" @selected(old('residency_status', 'Active') === $option)>{{ $option }}</option>
                        @endforeach
                    </select>
                </div>
