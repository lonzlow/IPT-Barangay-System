...
@section('styles')
    <style>
        ...
        .preview-panel .preview-header .ph-title {
            font-size: 13.5px;
            font-weight: 700;
            color: #0f172a;
            flex: 1;
        ...
        .doc-paper .dp-letterhead .dp-brgy {
            font-size: 15px;
            font-weight: 800;
            color: #0f172a;
            letter-spacing: .3px;
        ...
        .doc-paper .dp-letterhead .dp-gov {
            font-size: 10.5px;
            color: #64748b;
...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
        <div>
            ...
            <p class="mb-0" style="font-size:13px;color:#64748b;">Issue, track, and manage barangay certificates and
                clearances.</p>
        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="doc-stat">
                <div class="ds-ico" style="background:#eff6ff;color:#1a56db;"><i class="bi bi-file-earmark-check-fill"></i>
                </div>
                <div>
                    <div class="ds-num">549</div>
                    <div class="ds-lbl">Issued this month</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="doc-stat">
                ...
                <div>
                    ...
                    <div class="ds-lbl">Pending requests</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="doc-stat">
                ...
                <div>
                    <div class="ds-num">12</div>
                    <div class="ds-lbl">Ready to print</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="doc-stat">
                ...
                <div>
                    ...
                    <div class="ds-lbl">Cancelled today</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-5">
            <div class="form-card h-100">
                <div class="fc-heading"><i class="bi bi-pencil-square me-2 text-primary"></i>Generate Custom Letter /
                    Document</div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" style="font-size:13.5px;border-radius:8px;"
                ...
                <div class="mb-3">
                    <label class="form-label" style="font-size:12.5px;font-weight:600;">Additional Notes <span
                            style="font-weight:400;color:#94a3b8;">(optional)</span></label>
                    <textarea class="form-control" rows="3" style="font-size:13px;border-radius:8px;resize:none;"
                        placeholder="Any special instructions or inclusions…"></textarea>
                </div>
                <div class="d-flex gap-2">
                ...
                <div class="preview-body">
                    <div class="doc-paper">
                        ...
                        <div class="dp-letterhead">
                            ...
                            <div class="dp-brgy">BARANGAY New Era</div>
                            <div style="font-size:10.5px;color:#64748b;">Office of the Punong Barangay</div>
                        </div>
                        <div class="dp-title">Barangay Clearance</div>
                        <div class="dp-body">
                            <p>TO WHOM IT MAY CONCERN:</p>
                            <p>This is to certify that <strong>JUAN DELA CRUZ</strong>, of legal age, Filipino citizen, and
                                a bonafide resident of <strong>123 Mabini Street, Purok 1, Barangay New Era</strong>, is
                                personally known to this office to be of good moral character and has no derogatory record
                                on file with the Barangay.</p>
                            <p>This certification is issued upon the request of the above-named person for
                                <strong>employment purposes</strong> and for whatever legal purpose it may serve.</p>
                            <p>Issued this <strong>24th day of February 2025</strong> at Barangay New Era.</p>
                        </div>
                        <div class="dp-sig">
                        ...
                        <div style="margin-top:20px;font-size:10px;color:#9ca3af;text-align:right;">
                            Control No.: <strong>BRG-2025-0842</strong> &nbsp;·&nbsp; OR No.: __________ &nbsp;·&nbsp; Fee:
                            ₱50.00
                        </div>
                    </div>
                </div>
