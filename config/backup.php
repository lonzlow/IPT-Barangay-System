    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    str_replace('/', DIRECTORY_SEPARATOR, storage_path('app/public')),
                    str_replace('/', DIRECTORY_SEPARATOR, storage_path('app/private')),
                ],
                 ...
                 */
                'exclude' => [
                    str_replace('/', DIRECTORY_SEPARATOR, storage_path('app/private/'.env('APP_NAME', 'Laravel'))),
                 ...
                 * Example: base_path()
                 */
                'relative_path' => str_replace('/', DIRECTORY_SEPARATOR, storage_path('app')),
            ],
