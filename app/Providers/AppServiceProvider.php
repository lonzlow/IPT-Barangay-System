...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $fullReadAccess = array_merge($admin, $captain, $auditor);
        $committeeScopedRoles = array_merge($kagawad, $sk, $bhw, $bdrrm);

        Gate::define('dashboard.view', fn (User $u) => true);

        Gate::define('residents.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $bhw, $bdrrm, $encoder)));
        ...
        Gate::define('documents.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $treasurer, $encoder)));
        ...
        Gate::define('blotter.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $tanod, $encoder)));
        ...
        Gate::define('households.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $bhw, $bdrrm, $encoder)));
        ...
        Gate::define('business.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $treasurer, $encoder)));
        ...
        Gate::define('officials.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary)));
        Gate::define('officials.manage', fn (User $u) => $u->official?->hasAnyRole($admin));
        Gate::define('committees.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary, $committeeScopedRoles)));
        Gate::define('reports.view', fn (User $u) => $u->official?->hasAnyRole(array_merge($fullReadAccess, $secretary)));
        ...
        Gate::define('committee-records.manage', fn (User $u) => $u->official?->hasAnyRole(array_merge($admin, $secretary, $committeeScopedRoles)));
